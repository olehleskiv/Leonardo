...
<!-- Скрипт стіни фейсбуку -->
		...
		<script type="text/javascript" src="scripts/allversion.js"></script>
		...
		<style type="text/css">
		div.fixedBlock{
		/* IE5.5+/Win - трошки інакше ніж IE 5.0 версії */
...
<?php if ($PageToView=="map")  echo "onload=\"initialize()\"";?>>
	...
	foreach($availablePages as $ap)
	{
		echo "
				...
				";
					if ($MenuLines[$k+1]!="")
					{
						echo "<li class=\"seperator\" style=\"height: 38px;\">
				</li>";
					}
	}
	echo "
