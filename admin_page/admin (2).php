           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="#main"><i class="fa fa-dashboard fa-3x"></i> Управління сайтом</a>
                    </li>
                    <li>
                    ...
                    <li  >
                     ...
                     <li  >
                        <a   href="registeration.html"><i class="fa fa-laptop fa-3x"></i> Registration</a>
                    </li> 
